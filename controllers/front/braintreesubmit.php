...
class PayPalBraintreeSubmitModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        switch ($cart_status) {
            ...
            default:
                ...
                $id_braintree_presta = $braintree->saveTransaction(['id_cart' => $this->context->cart->id, 'nonce_payment_token' => Tools::getValue('payment_method_nonce'), 'client_token' => Tools::getValue('client_token'), 'datas' => Tools::getValue('deviceData')]);
    ...
    public function getOrderInformation()
    {
        ...
        exit(Tools::jsonEncode($responseContent));
    }
}
