...
use PaypalAddons\classes\API\ExtensionSDK\Webhook\ShowEventNotification;
...
class PaypalGetWebhookEventRequest extends RequestAbstract
{
    protected $id;
    ...
    public function execute()
    {
        ...
        $request = new ShowEventNotification($this->id);
        ...
        try {
            ...
            $response->setSuccess(true)->setData($exec)->setEvent(new WebhookEvent(json_encode($exec->result)));
    ...
    /** @return ResponseWebhookEventDetail*/
    protected function getResponse()
    {
        return new ResponseWebhookEventDetail();
    }
}
