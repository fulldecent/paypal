...
use PaypalPPBTlib\Extensions\Diagnostic\Stubs\Handler\ConflictsStubHandler;
...
class ConflictsStub extends AbstractStub
{
    ...
    {
        parent::__construct();
        $this->tpl = _PS_MODULE_DIR_ . 'paypal/views/templates/admin/diagnostic/conflicts.tpl';
