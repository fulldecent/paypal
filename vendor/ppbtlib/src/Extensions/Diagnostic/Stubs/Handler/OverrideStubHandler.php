...
class OverrideStubHandler extends AbstractStubHandler
{
    public function handle()
    {
        $overrideFiles = Tools::scandir(_PS_OVERRIDE_DIR_, 'php', '', true);
        $overrides = array_filter($overrideFiles, function ($file) {
